...
backend_proc = subprocess.Popen([python_path, "-m", "uvicorn", "main:app", "--host", "0.0.0.0", "--port", "8000"], cwd=backend_cwd, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
